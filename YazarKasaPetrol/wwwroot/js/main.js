    ...
    $.ajax({
        ...
        success: function (theData)
        {
            ...
            else
            {
                ...
                $("#invoiceText_1").prop("disabled", true);
                $("#invoiceText_2").prop("disabled", true);
                $("#invoiceText_4").prop("disabled", true);
                $("#invoiceText_5").prop("disabled", true);
                $("#invoiceText_6").prop("disabled", true);
                $("#invoiceText_7").prop("disabled", true);
                $("#invoiceText_8").prop("disabled", true);
                $("#invoiceText_9").prop("disabled", true);
                $("#invoiceText_10").prop("disabled", true);
                $("#invoiceText_11").prop("disabled", true);
